 ...
 * Page class
 */
class BroadcastDelete extends Broadcast
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BroadcastDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "BroadcastDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("BroadcastList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("BroadcastList"); // Return to list
                return;
            }
        }
