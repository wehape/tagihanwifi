...
class SubscriptionDelete extends Subscription
{
    ...
    // Page object name
    public $PageObjName = "SubscriptionDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "SubscriptionDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("SubscriptionList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("SubscriptionList"); // Return to list
                return;
            }
        }
