 ...
 * Page class
 */
class BroadcastView extends Broadcast
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BroadcastView";
    ...
    // CSS class/style
    public $CurrentPageName = "BroadcastView";
    ...
    public function __construct()
    {
        ...
        // Table CSS class
        $this->TableClass = "table table-striped table-borderless table-hover ew-view-table d-none";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("NomorBC") ?? Route("NomorBC")) !== null) {
            ...
            $this->RecKey["NomorBC"] = $this->NomorBC->QueryStringValue;
        } elseif (Post("NomorBC") !== null) {
            $this->NomorBC->setFormValue(Post("NomorBC"));
            $this->RecKey["NomorBC"] = $this->NomorBC->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->NomorBC->setQueryStringValue($keyValue);
            $this->RecKey["NomorBC"] = $this->NomorBC->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "BroadcastList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "BroadcastList"; // No matching record, return to list
                    } else {
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fbroadcastview" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-key="' . ArrayToJsonAttribute($this->RecKey) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
