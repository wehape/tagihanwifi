 ...
 * Page class
 */
class BandwidthView extends Bandwidth
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BandwidthView";
    ...
    // CSS class/style
    public $CurrentPageName = "BandwidthView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("NomorBandwidth") ?? Route("NomorBandwidth")) !== null) {
            $this->RecKey["NomorBandwidth"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("NomorBandwidth") ?? Route("NomorBandwidth")) !== null) {
            ...
            $this->RecKey["NomorBandwidth"] = $this->NomorBandwidth->QueryStringValue;
        } elseif (Post("NomorBandwidth") !== null) {
            $this->NomorBandwidth->setFormValue(Post("NomorBandwidth"));
            $this->RecKey["NomorBandwidth"] = $this->NomorBandwidth->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->NomorBandwidth->setQueryStringValue($keyValue);
            $this->RecKey["NomorBandwidth"] = $this->NomorBandwidth->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "BandwidthList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "BandwidthList"; // No matching record, return to list
                    } else {
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fbandwidthview" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-key="' . ArrayToJsonAttribute($this->RecKey) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
