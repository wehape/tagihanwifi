 ...
 * Page class
 */
class DataPelangganView extends DataPelanggan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DataPelangganView";
    ...
    // CSS class/style
    public $CurrentPageName = "DataPelangganView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("NomorPelanggan") ?? Route("NomorPelanggan")) !== null) {
            $this->RecKey["NomorPelanggan"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("NomorPelanggan") ?? Route("NomorPelanggan")) !== null) {
            ...
            $this->RecKey["NomorPelanggan"] = $this->NomorPelanggan->QueryStringValue;
        } elseif (Post("NomorPelanggan") !== null) {
            $this->NomorPelanggan->setFormValue(Post("NomorPelanggan"));
            $this->RecKey["NomorPelanggan"] = $this->NomorPelanggan->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->NomorPelanggan->setQueryStringValue($keyValue);
            $this->RecKey["NomorPelanggan"] = $this->NomorPelanggan->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "DataPelangganList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("DataPelangganList"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->NomorPelanggan->CurrentValue, $this->CurrentRow['NomorPelanggan'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "DataPelangganList"; // No matching record, return to list
                    } else {
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fdata_pelangganview" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-key="' . ArrayToJsonAttribute($this->RecKey) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
