 ...
 * Page class
 */
class SubscriptionAdd extends Subscription
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SubscriptionAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "SubscriptionAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "SubscriptionView") {
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            if (!$this->NomorSubscription->Raw) {
                $this->NomorSubscription->CurrentValue = HtmlDecode($this->NomorSubscription->CurrentValue);
            }
            $this->NomorSubscription->EditValue = HtmlEncode($this->NomorSubscription->CurrentValue);
            $this->NomorSubscription->PlaceHolder = RemoveHtml($this->NomorSubscription->caption());
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->NomorSubscription->CurrentValue != "") { // Check field with unique index
            $filter = "(`NomorSubscription` = '" . AdjustSql($this->NomorSubscription->CurrentValue, $this->Dbid) . "')";
        ...
        if ($insertRow && $this->ValidateKey && strval($rsnew['NomorSubscription']) == "") {
    ...
    protected function getAddRow()
    {
        ...
        // NomorSubscription
        $this->NomorSubscription->setDbValueDef($rsnew, $this->NomorSubscription->CurrentValue, false);
    ...
    {
        if (isset($row['NomorSubscription'])) { // NomorSubscription
            $this->NomorSubscription->setFormValue($row['NomorSubscription']);
        }
