 ...
 * Page class
 */
class DataPelangganDelete extends DataPelanggan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DataPelangganDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "DataPelangganDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DataPelangganList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("DataPelangganList"); // Return to list
                return;
            }
        }
