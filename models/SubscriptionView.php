...
class SubscriptionView extends Subscription
{
    ...
    // Page object name
    public $PageObjName = "SubscriptionView";
    ...
    // CSS class/style
    public $CurrentPageName = "SubscriptionView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("NomorSubscription") ?? Route("NomorSubscription")) !== null) {
            $this->RecKey["NomorSubscription"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("NomorSubscription") ?? Route("NomorSubscription")) !== null) {
            ...
            $this->RecKey["NomorSubscription"] = $this->NomorSubscription->QueryStringValue;
        } elseif (Post("NomorSubscription") !== null) {
            $this->NomorSubscription->setFormValue(Post("NomorSubscription"));
            $this->RecKey["NomorSubscription"] = $this->NomorSubscription->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->NomorSubscription->setQueryStringValue($keyValue);
            $this->RecKey["NomorSubscription"] = $this->NomorSubscription->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "SubscriptionList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "SubscriptionList"; // No matching record, return to list
                    } else {
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fsubscriptionview" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-key="' . ArrayToJsonAttribute($this->RecKey) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
