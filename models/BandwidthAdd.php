 ...
 * Page class
 */
class BandwidthAdd extends Bandwidth
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BandwidthAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "BandwidthAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "BandwidthView") {
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            if (!$this->NomorBandwidth->Raw) {
                $this->NomorBandwidth->CurrentValue = HtmlDecode($this->NomorBandwidth->CurrentValue);
            }
            $this->NomorBandwidth->EditValue = HtmlEncode($this->NomorBandwidth->CurrentValue);
            $this->NomorBandwidth->PlaceHolder = RemoveHtml($this->NomorBandwidth->caption());
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->NomorBandwidth->CurrentValue != "") { // Check field with unique index
            $filter = "(`NomorBandwidth` = '" . AdjustSql($this->NomorBandwidth->CurrentValue, $this->Dbid) . "')";
        ...
        if ($this->Bandwidth->CurrentValue != "") { // Check field with unique index
            $filter = "(`Bandwidth` = '" . AdjustSql($this->Bandwidth->CurrentValue, $this->Dbid) . "')";
            $rsChk = $this->loadRs($filter)->fetch();
            if ($rsChk !== false) {
        ...
        if ($insertRow && $this->ValidateKey && strval($rsnew['NomorBandwidth']) == "") {
    ...
    protected function getAddRow()
    {
        ...
        // NomorBandwidth
        $this->NomorBandwidth->setDbValueDef($rsnew, $this->NomorBandwidth->CurrentValue, false);
    ...
    {
        if (isset($row['NomorBandwidth'])) { // NomorBandwidth
            $this->NomorBandwidth->setFormValue($row['NomorBandwidth']);
        }
