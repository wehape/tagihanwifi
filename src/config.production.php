...
return [
    "Databases" => [
        "DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "sql6.freemysqlhosting.net", "port" => "3306", "user" => "sql6686551", "password" => "EZLtw3mVtX", "dbname" => "sql6686551"]
    ],
    "SMTP" => [
    ...
    "JWT" => [
        "SECRET_KEY" => "GYpyFZ+6Z3ffZbl/ieNqxAiLyMsse0zNz4SOmhPrjKM=", // JWT secret key
